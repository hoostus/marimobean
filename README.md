...
# Test it in Molab without downloading anything

[![Open in molab](https://marimo.io/molab-shield.svg)](https://molab.marimo.io/github/hoostus/marimobean/blob/main/pnl.py) Click me to run in Molab.
